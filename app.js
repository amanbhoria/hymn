...
// res.render will use view engine to render a particular page.  Inside views folder
...
app.use(express.static("public"))  //to incorporate with css pages.
// assume we're in public folder
